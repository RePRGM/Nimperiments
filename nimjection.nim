...
when defined(windows):
    ...
    when defined(i386):
        ...
        echo "[*] Running in x64 process"
        #const file = slurp("message4.bin")
        #let scFile = readFile("message4.bin")
        #let shellcode = scFile.toByteSeq
        #const shellcode = file.toByteSeq
        #const scLen = shellcode.len
        #let scArray: array[scLen, byte] = unsafeAddr shellcode
